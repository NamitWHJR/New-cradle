...
function setup() {
	...
	Bob1 = new Bob(200,425,35)

	Bob2 = new Bob(320,425,35)

	Bob3 = new Bob(450,425,35)

	Bob4 = new Bob(580,425,35)

	Bob5 = new Bob(200,425,35)
...
function keyPressed() {
	...
	if (keyCode === UP_ARROW){
		...
		//Matter.Body.setPosition(Bob1.body,{x:50,y:50})
	}
